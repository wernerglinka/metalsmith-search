    ...
    it('should extract traditional markdown content', function (done) {
      metalsmith
        ...
        .build(function (err, files) {
          ...
          assert.ok(hasSectionLevel || indexContent.entries.length > 0, 'Should have section-level entries or content');
    ...
    it('should respect ignore patterns', function (done) {
      metalsmith
        ...
        .build(function (err, files) {
          ...
          const hasIgnoredContent = indexContent.entries.some(entry => 
            entry.url && entry.url.includes('real-world-example')
          );
